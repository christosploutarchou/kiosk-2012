...
Module SqliteModule
    ...
    Private Sub CreateReceiptsDetTable()
        Dim sql As String =
                            ...
                            CREATE INDEX IF NOT EXISTS IDX_RECEIPTSDET_KIOSK_DATE ON RECEIPTS_DET(KIOSKID, CREATED_ON);
                            CREATE INDEX IF NOT EXISTS IDX_RECEIPTS_REPORT ON RECEIPTS (KIOSKID, CREATED_ON, TOTAL_VAT5, TOTAL_VAT19, TOTAL_VAT0,TOTAL_VAT3);
                            "
