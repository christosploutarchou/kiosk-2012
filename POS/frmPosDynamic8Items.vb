Public Class frmPosDynamic8Items
    Dim tmpBtnItem As BtnItem

    Private Sub frmDynamic8Items_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
