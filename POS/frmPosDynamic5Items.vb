Public Class frmPosDynamic5Items
    Dim tmpBtnItem As BtnItem

    Private Sub frmPosDynamic5Items_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
